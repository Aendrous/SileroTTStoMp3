...
### Настройки Yandex SpeechKit (для лучшего качества)
![Настройки Yandex](screenshots/yandex_settings.png)
- Зарегистрируйтесь на cloud.yandex.ru
- Создайте платежный аккаунт (есть бесплатный стартовый грант)
- Создайте сервисный аккаунт
Получите:
- API Key (Ключ API)
- Folder ID (Идентификатор каталога)
- В коде найдите по слову "Folder" и введите данные (мои старые только для теста)
